...
These instructions will get you up and running with **WildFly 9.0.0.Beta1**. To run WildFly 8.2.0.Final instead, take a look at the documentation [here](https://github.com/openshift-cartridges/openshift-wildfly-cartridge/tree/wildfly-8).
